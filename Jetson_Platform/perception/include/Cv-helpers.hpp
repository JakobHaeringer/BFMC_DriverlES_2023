 ...
 * @brief This file includes helper functions for easier usage of OpenCV and librealsense.
 * @version 1.0
 * @date 2023-06-15
 *
...
/**
 * @brief This function extracts the depth information of the realsense depth frame into an OpenCV matrix.
 *
 * @param f The realsense frame that should be transformed.
 * @return cv::Mat The resulting OpenCV matrix object.
 */
